# Generated by Django 2.2.14 on 2024-01-22 11:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('RC', 'Republican China'), ('RPC', "People's Republican China"), ('JP', 'Japan')], max_length=3)),
                ('label', models.CharField(choices=[('F', 'Sold Out'), ('T', 'On Sale')], max_length=1)),
                ('slug', models.SlugField()),
                ('description', models.TextField()),
                ('image', models.ImageField(upload_to='')),
                ('detail_image_1', models.ImageField(upload_to='')),
                ('detail_image_2', models.ImageField(upload_to='')),
                ('detail_image_3', models.ImageField(upload_to='')),
                ('addictional_info', models.TextField()),
            ],
        ),
        migrations.CreateModel(
            name='Order',
